...
export const metadata: Metadata = {
  title: '陈慕宇 - 长沙前端开发工程师 | iaxixi.com',
  description: '陈慕宇，长沙资深Web前端开发工程师，专注于React、Next.js、JavaScript等现代前端技术开发，提供专业的前端解决方案',
  keywords: [
    '陈慕宇', 'iaxixi', '前端开发工程师', '长沙前端开发', 
  ...
  openGraph: {
    ...
    title: '陈慕宇 - 长沙前端开发工程师',
    description: '长沙资深Web前端开发工程师，专注现代前端技术',
    siteName: 'iaxixi - 陈慕宇',
    images: [
      {
        url: '/cmy.jpg',
